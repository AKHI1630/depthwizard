"""Run full pipeline on Turkey WV03 crops and report results."""
import glob
import json
import math
import os
...
crops = sorted(glob.glob("data/crops/crop*_turkey_*.tif"))
print(f"Found {len(crops)} Turkey crops")

# Sun from STAC tile metadata (view:sun_elevation, view:sun_azimuth)
sun_elev = 34.3
sun_az = 156.3
gsd = 0.305  # from tile metadata
...
print(f"Scene: 1040010082698700 (WV03), 2023-02-07 08:27 UTC")
print(f"Location: Pazarcik area, Kahramanmaras, Turkey (37.31N, 36.66E)")
print()
...
if len(crop_azimuths) >= 2:
    ...
    print(f"  STAC sun azimuth:    {sun_az} deg")
...
print(f"\nSTAC sun (from tile metadata): elev={sun_elev} deg, az={sun_az} deg (SSE)")
print(f"Scene: 1040010082698700 (WV03), 2023-02-07 08:27 UTC, Pazarcik, Turkey")
